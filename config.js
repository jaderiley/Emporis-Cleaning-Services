...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Emporis Cleaning Services",
    phone:     "+27 71 170 1523",
    whatsapp:  "+27 71 170 1523",
    address:   "Caroline Cres, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Emporis Cleaning Services — Cleaning services in johannesburg",
    description: "Emporis Cleaning Services provides professional cleaning services in Johannesburg. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Cleaning services · Johannesburg & surrounds",
    heroTitle:  "Spotless, every time — <em>professional cleaning.</em>",
    heroLead:   "Emporis Cleaning Services provides professional domestic and commercial cleaning services across Johannesburg. Regular cleans, deep cleans and once-off services available.",
    ...
    band: {
      ...
      alt:   "Emporis Cleaning Services team at work in Johannesburg",
      text:  "A clean home or office, every time — professional and reliable."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Serving Johannesburg and the surrounding area.",
    areasLead:  "We cover Johannesburg CBD, Parktown, Melville and the wider region. Regular contracts and once-off cleans both available.",
